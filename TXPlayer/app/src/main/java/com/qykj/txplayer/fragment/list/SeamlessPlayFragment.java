package com.qykj.txplayer.fragment.list;
...
import com.qykj.txplayer.activity.list.DetailActivity;
 ...
 * 无缝播放
 */
public class SeamlessPlayFragment extends RecyclerViewFragment {
    ...
    protected void pause() {
        Log.e("ijk--->","SeamlessPlayFragment -- pause");
        if (!mSkipToDetail) {
            super.pause();
        }
    }
    ...
    protected void resume() {
        Log.e("ijk--->","SeamlessPlayFragment -- resume");
    ...
    @Override
    public void onStart() {
        Log.e("ijk--->","SeamlessPlayFragment -- onStart");
    ...
    private void restoreVideoView() {
        Log.e("ijk--->","SeamlessPlayFragment -- restoreVideoView");
